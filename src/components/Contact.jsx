...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_mhisziv', 'template_blfema9', form.current, 'XixhOWojGvXUyC-Hu')
            .then((result) => {
        ...
        <div name="Contact" className='pt-10 h-full min-h-screen w-full flex items-center bg-gradient-to-b to-gray-800 from-black'>
            <div className='section'>
                ...
                <div className='flex justify-center items-center'>
                    <form ref={form} onSubmit={sendEmail} className='flex gap-3 flex-col w-full md:w-1/2 '>
                        ...
                        <div className=" w-full">
                            <div className="relative">
                                <textarea name="message" placeholder='Your Message' rows="10" cols="30" className={`peer form-input ${errData.messageError !== "" && "border-red-500"}`} value={formData.message} onChange={handleChange} />
                                <FormIcon name="chat" />
                            </div>
