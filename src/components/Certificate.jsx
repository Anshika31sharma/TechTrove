...
const Certificates = ({ project: { img, demo, code, description, title, subtitle, style = { shadow: "shadow-gray-500", cover: "from-gray-500" } } }) => {
    return (
        <Card style={style}>
            ...
            <div className='flex flex-col items-center rounded-b-md p-4'>
                ...
                <div className='flex justify-center items-center'>
                    <CertificatesLink name="Link" style={"rounded-bl-lg " + style.cover} link={code} />
                </div>
            </div>
        </Card>
    );
...
const CertificatesLink = ({ name, link, style }) => {
    return (
